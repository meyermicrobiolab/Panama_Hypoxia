...
get_taxa_unique(ps5, "Genus") #298
# filtered ASVs with very low abundance with phyloseq, now export otu and taxa tables from phyloseq for codaseq, SAVE these following tables for replication
...
ps5 = subset_samples(ps5, Site == "Punta Caracol")
```
...
str(d.pcx)
screeplot(d.pcx)
d.pcx$sdev^2 #prints eigenvalues from the prcomp singular value decomposition
...
perm<-adonis2(dist.clr~treat*species,as(sample_data(ps5),"data.frame"))
print(perm)
```
...
p<-plot_richness(ps5, x="Treatment",color="Species", measures=c("Chao1", "Shannon", "Simpson"))
p<-p+geom_point(size=3)+
...
cols<-c("1"="#C9A456","2"="#E27741","3"="#1A5276","4"="#CB4E07","5"="#8A9B5E","6"="#EFA5B5","7"="#FFC54F","8"="#B04029","9"="#ABC9CB")
