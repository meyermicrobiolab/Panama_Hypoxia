...
##Next, we subset the data as desired by calling the specific columns we want to include in our boxplot figure. I’ve chosen the top four most significant ASVs associated with the “Hypoxia plots” grouping (stat-value>.50)
